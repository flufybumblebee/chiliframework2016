...
void Graphics::DrawRect(bool filled, int left, int top, int width, int height, Color color)
{
	if (filled)
	{
	...
	{
		DrawLine(left, top, left + width - 1, top, color);
		DrawLine(left, top + height - 1, left + width - 1, top + height - 1, color);
		DrawLine(left, top, left, top + height - 1, color);
		DrawLine(left + width - 1, top, left + width - 1, top + height - 1, color);
	}
}